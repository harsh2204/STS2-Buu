...
public sealed class MajinRage() : BuuCard(1, CardType.Attack, CardRarity.Uncommon, TargetType.AnyEnemy)
{
    private const decimal KiCost = 1m;
    private const decimal DamageBase = 12m;
    private const decimal DamageUpgraded = 16m;
