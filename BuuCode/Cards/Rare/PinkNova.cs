...
public sealed class PinkNova() : BuuCard(2, CardType.Attack, CardRarity.Rare, TargetType.AllEnemies)
{
    private const decimal DamageBase = 20m;
    private const decimal DamageUpgraded = 28m;
